...
func play_dialogue(resource: AudioStream, crossfade_duration: float = 0.0, override_bus: String = "") -> AudioStreamPlayer:
	return dialogue.play(resource, 0.0, 0.0, crossfade_duration, override_bus)

func play_dialogue_from_position(resource: AudioStream, position: float = 0.0, crossfade_duration: float = 0.0, override_bus: String = "") -> AudioStreamPlayer:
	return dialogue.play(resource, position, 0.0, crossfade_duration, override_bus)
...
func play_dialogue_at_volume(resource: AudioStream, volume: float = 0.0, crossfade_duration: float = 0.0, override_bus: String = "") -> AudioStreamPlayer:
	return dialogue.play(resource, 0.0, volume, crossfade_duration, override_bus)

func play_dialogue_from_position_at_volume(resource: AudioStream, position: float = 0.0, volume: float = 0.0, crossfade_duration: float = 0.0, override_bus: String = "") -> AudioStreamPlayer:
	return dialogue.play(resource, position, volume, crossfade_duration, override_bus)
