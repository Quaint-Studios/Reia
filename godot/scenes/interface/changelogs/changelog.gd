...
const fs = preload("res://src/utils/fs.gd")
const changes_prefab = preload("res://scenes/interface/changelogs/changes.tscn")
const h_divider_prefab = preload("res://scenes/interface/changelogs/h_divider.tscn")
...
func read_changelog(data: Dictionary):
	...
	var changelog = changes_prefab.instantiate()
